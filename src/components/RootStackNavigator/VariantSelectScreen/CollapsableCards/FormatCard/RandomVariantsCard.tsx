...
import { RandomVariantsIcon } from "primitives/icons/Formats";

const RandomVariantsCard: SFC<CurrentCardProps> = ({
  selectedVariants,
  setSelectedVariants,
  style,
}) => {
  return (
    <CollapsableCard
      ...
      TitleComponent={RandomVariantsIcon}
      style={style}
    >
      {selectedVariants.length !== 0 ? (
        ...
        >
          {"A variant composition is chosen at random"}
        </Text>
      )}
    </CollapsableCard>
  );
