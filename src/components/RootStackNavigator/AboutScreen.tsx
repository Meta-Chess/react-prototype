  ...
  return (
    <ScreenContainer style={{ alignItems: "center", paddingVertical: 24 }}>
      ...
      <View style={{ maxWidth: 800 }}>
        ...
        <P>
          Some of the rules of chess can be interpreted in different ways in the context
          of variants. Here are a few of our thoughts on the topic.
        </P>

        <H3>Check</H3>
        <P>
          Whats the core idea behind check? We believe that it’s about doing justice to
          interesting positions. Blundering a piece feels bad - almost game ruining.
          Without check its possible to blunder your king, which could cut countless good
          games short. Our interpretation of check makes it illegal to make any move that
          would give your opponent(s) a move that would leave you with no kings. If you
          want to put the king on the chopping block: uncheck the check checking checkbox.
        </P>

        <H3>Castling</H3>
        <P>
          On mchess, you can castle if you can move your king two steps towards one of
          your rooks, there are no pieces between your king and that rook, the rook can
          get to the square the king moves through, and neither piece has moved before.
        </P>
        ...
        <P>
          ...
          pawns be captured in passing (by other pawns) if they&apos;ve just
          double-stepped, and we allow kings to be captured in passing (by any piece-type)
          if they&apos;ve just castled.
        </P>
        <P>
        ...
        <P>
          We don&apos;t promise this software works as described. Please report any bugs
          you notice, either through the form in the help menu, or by emailing
