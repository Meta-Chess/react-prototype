...
describe("In atomic chess", () => {
  it("The following sequence of moves is stalemate", () => {
    ...
    // e4
    gameMaster.handleSquarePressed(toLocation({ file: 5, rank: 2 }));
    gameMaster.handleSquarePressed(toLocation({ file: 5, rank: 4 }));
    expect(board.getPiecesAt(toLocation({ file: 5, rank: 4 })).length).toEqual(1);

    // f5
    gameMaster.handleSquarePressed(toLocation({ file: 6, rank: 7 }));
    gameMaster.handleSquarePressed(toLocation({ file: 6, rank: 5 }));
    expect(board.getPiecesAt(toLocation({ file: 6, rank: 5 })).length).toEqual(1);

    // ba6
    gameMaster.handleSquarePressed(toLocation({ file: 6, rank: 1 }));
    gameMaster.handleSquarePressed(toLocation({ file: 1, rank: 6 }));
    ...
    // bxb7
    gameMaster.handleSquarePressed(toLocation({ file: 1, rank: 6 }));
    gameMaster.handleSquarePressed(toLocation({ file: 2, rank: 7 }));
    expect(board.getPiecesAt(toLocation({ file: 2, rank: 7 })).length).toEqual(0);

    // e6
    gameMaster.handleSquarePressed(toLocation({ file: 5, rank: 7 }));
    gameMaster.handleSquarePressed(toLocation({ file: 5, rank: 6 }));
    expect(board.getPiecesAt(toLocation({ file: 5, rank: 6 })).length).toEqual(1);

    // d5
    gameMaster.handleSquarePressed(toLocation({ file: 4, rank: 2 }));
    gameMaster.handleSquarePressed(toLocation({ file: 4, rank: 4 }));
    expect(board.getPiecesAt(toLocation({ file: 4, rank: 4 })).length).toEqual(1);

    // a5
    gameMaster.handleSquarePressed(toLocation({ file: 1, rank: 7 }));
    gameMaster.handleSquarePressed(toLocation({ file: 1, rank: 5 }));
    expect(board.getPiecesAt(toLocation({ file: 1, rank: 5 })).length).toEqual(1);

    // bh6
    gameMaster.handleSquarePressed(toLocation({ file: 3, rank: 1 }));
    gameMaster.handleSquarePressed(toLocation({ file: 8, rank: 6 }));
    expect(board.getPiecesAt(toLocation({ file: 8, rank: 6 })).length).toEqual(1);

    //qf6
    gameMaster.handleSquarePressed(toLocation({ file: 4, rank: 8 }));
    gameMaster.handleSquarePressed(toLocation({ file: 6, rank: 6 }));
    expect(board.getPiecesAt(toLocation({ file: 6, rank: 6 })).length).toEqual(1);

    // bxg7
    gameMaster.handleSquarePressed(toLocation({ file: 8, rank: 6 }));
    gameMaster.handleSquarePressed(toLocation({ file: 7, rank: 7 }));
    expect(board.getPiecesAt(toLocation({ file: 7, rank: 7 })).length).toEqual(0);

    // c5
    gameMaster.handleSquarePressed(toLocation({ file: 3, rank: 7 }));
    gameMaster.handleSquarePressed(toLocation({ file: 3, rank: 5 }));
    ...
    // d5
    gameMaster.handleSquarePressed(toLocation({ file: 4, rank: 7 }));
    gameMaster.handleSquarePressed(toLocation({ file: 4, rank: 5 }));
    expect(board.getPiecesAt(toLocation({ file: 4, rank: 5 })).length).toEqual(1);

    // c4
    gameMaster.handleSquarePressed(toLocation({ file: 3, rank: 2 }));
    gameMaster.handleSquarePressed(toLocation({ file: 3, rank: 4 }));
    ...
    // b4
    gameMaster.handleSquarePressed(toLocation({ file: 2, rank: 2 }));
    gameMaster.handleSquarePressed(toLocation({ file: 2, rank: 4 }));
    ...
    // f4
    gameMaster.handleSquarePressed(toLocation({ file: 6, rank: 2 }));
    gameMaster.handleSquarePressed(toLocation({ file: 6, rank: 4 }));
    ...
    // h5
    gameMaster.handleSquarePressed(toLocation({ file: 8, rank: 7 }));
    gameMaster.handleSquarePressed(toLocation({ file: 8, rank: 5 }));
    expect(board.getPiecesAt(toLocation({ file: 8, rank: 5 })).length).toEqual(1);

    // g4
    gameMaster.handleSquarePressed(toLocation({ file: 7, rank: 2 }));
    gameMaster.handleSquarePressed(toLocation({ file: 7, rank: 4 }));
    expect(board.getPiecesAt(toLocation({ file: 7, rank: 4 })).length).toEqual(1);

    // e5
    gameMaster.handleSquarePressed(toLocation({ file: 5, rank: 6 }));
    gameMaster.handleSquarePressed(toLocation({ file: 5, rank: 5 }));
    expect(board.getPiecesAt(toLocation({ file: 5, rank: 5 })).length).toEqual(1);

    // ne2
    gameMaster.handleSquarePressed(toLocation({ file: 7, rank: 1 }));
    gameMaster.handleSquarePressed(toLocation({ file: 5, rank: 2 }));
    ...
    // ke7
    gameMaster.handleSquarePressed(toLocation({ file: 5, rank: 8 }));
    gameMaster.handleSquarePressed(toLocation({ file: 5, rank: 7 }));
    expect(board.getPiecesAt(toLocation({ file: 5, rank: 7 })).length).toEqual(1);

    //qd4
    gameMaster.handleSquarePressed(toLocation({ file: 4, rank: 1 }));
    gameMaster.handleSquarePressed(toLocation({ file: 4, rank: 4 }));
    expect(board.getPiecesAt(toLocation({ file: 4, rank: 4 })).length).toEqual(1);
